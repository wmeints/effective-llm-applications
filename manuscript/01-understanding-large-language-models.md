...
Google published **Gemma2:** in February 2024 and trained it using a [teacher/student
technique][HUGGINGFACE_GEMMA2]. The training technique looks very interesting, but
Gemma2 isn't quite as good for many of the tasks I worked on as the other models in the
open-source space.
...
- **DeepSeek** is another new model that's showing great promise. The R1 variant of
  ...
  keep in mind that the DeepSeek models only support English and Chinese. 
