...
public class RandomDecisionMakingProcess
{
    ...
    public RandomDecisionMakingProcess()
    {
        ...
        generateRandomNumberStep.OnFunctionResult().SendEventTo(new ProcessFunctionTargetBuilder(makeDecisionStep));

        makeDecisionStep.OnEvent("HighOutcome").SendEventTo(new ProcessFunctionTargetBuilder(handleHighOutcomeStep));
        makeDecisionStep.OnEvent("LowOutcome").SendEventTo(new ProcessFunctionTargetBuilder(handleLowOutcomeStep));
